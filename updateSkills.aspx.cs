    ...
    public partial class updateSkills : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand("SELECT * FROM ryad WHERE id=" + id + "", conn);
        ...
        protected void updateButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("UPDATE ryad SET Field=@Field, Description=@Description WHERE Id=@Id", conn);
